...
<body>
    ...
    <div id="sidebar">
        <header class="logo">Supprimer</header>
        <ul>
            ...
            <div class="box-check">
                ...
                <div class="">
                    ...
                    <h5 class="card-header info-color white-text text-center py-4">
                        <strong>Supprimer Patient</strong>
                    </h5>

                    <!--Card content-->
                    <div class="card-body px-lg-5 pt-0">
                        <form class="text-center" style="color: #757575;" action="index.php?action=supp" method="post">
                            ...
                            <p><?=$_SESSION['malade']['nom'] ?> <?=$_SESSION['malade']['prenom'] ?> <?=$_SESSION['malade']['postnom'] ?>
                              <a href="index.php?action=supprime&amp;id=<?=$_SESSION['malade']['id'] ?>">Supprimer</a>
                            </p>
